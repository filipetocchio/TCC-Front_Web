  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 p-6 ml-64">
        <h1 className="text-2xl font-bold mb-2">Bem-vindo à sua Dashboard</h1>
        ...
        <Link
          ...
          className="inline-block px-6 py-3 bg-black text-white rounded-2xl text-sm font-medium hover:bg-gray-800 transition-all duration-300 shadow-md mb-8"
        >
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-gold text-black rounded-xl font-medium hover:bg-yellow-500 transition"
                    >
                      Gerenciar
                    </button>
                  </div>
